...
// large dataset showing product categories and items
// demonstrates how ApexSankey automatically handles overlapping labels
const data: GraphData = {
  nodes: [
    ...
    { id: "Zaanse koeken", title: "Zaanse koeken" },
    { id: "Chocolade", title: "Chocolade" },
    { id: "Maxilaku", title: "Maxilaku" },
    { id: "Valkoinen suklaa", title: "Valkoinen suklaa" },
    { id: "Manjimup Dried Apples", title: "Manjimup Dried Apples" },
    { id: "Filo Mix", title: "Filo Mix" },
    { id: "Tourtière", title: "Tourtière" },
    { id: "Pâté chinois", title: "Pâté chinois" },
    { id: "Gnocchi di nonna Alice", title: "Gnocchi di nonna Alice" },
    { id: "Ravioli Angelo", title: "Ravioli Angelo" },
    { id: "Escargots de Bourgogne", title: "Escargots de Bourgogne" },
    { id: "Raclette Courdavault", title: "Raclette Courdavault" },
    { id: "Camembert Pierrot", title: "Camembert Pierrot" },
    { id: "Sirop d'érable", title: "Sirop d'érable" },
    { id: "Tarte au sucre", title: "Tarte au sucre" },
    { id: "Vegie-spread", title: "Vegie-spread" },
    { id: "Wimmers gute Semmelknödel", title: "Wimmers gute Semmelknödel" },
    { id: "Louisiana Fiery Hot Pepper Sauce", title: "Louisiana Fiery Hot Pepper Sauce" },
    { id: "Louisiana Hot Spiced Okra", title: "Louisiana Hot Spiced Okra" },
    { id: "Laughing Lumberjack Lager", title: "Laughing Lumberjack Lager" },
    { id: "Scottish Longbreads", title: "Scottish Longbreads" },
    { id: "Gudbrandsdalsost", title: "Gudbrandsdalsost" },
    { id: "Outback Lager", title: "Outback Lager" },
    { id: "Flotemysost", title: "Flotemysost" },
    { id: "Mozzarella di Giovanni", title: "Mozzarella di Giovanni" },
    { id: "Röd Kaviar", title: "Röd Kaviar" },
    { id: "Longlife Tofu", title: "Longlife Tofu" },
    { id: "Rhönbräu Klosterbier", title: "Rhönbräu Klosterbier" },
    { id: "Lakkalikööri", title: "Lakkalikööri" },
    { id: "Original Frankfurter grüne Soße", title: "Original Frankfurter grüne Soße" },
  ],
  edges: [
    ...
    { source: "Dairy Products", target: "Gorgonzola Telino", value: 5 },
    ...
    { source: "Grains-Cereals", target: "Wimmers gute Semmelknödel", value: 22 },
    { source: "Condiments", target: "Louisiana Fiery Hot Pepper Sauce", value: 76 },
    ...
    { source: "Condiments", target: "Original Frankfurter grüne Soße", value: 32 },
  ],
};
...
export default function NodeOverlapping() {
  return (
    <div className="example-container">
      <div className="example-header">
        <h2>Large Dataset with Auto Label Management</h2>
        <p>
          Product inventory flow with 77 nodes. ApexSankey automatically manages
          label visibility when nodes are too close together, hiding overlapping
          text while maintaining readability. Hover over nodes to see tooltips
          for hidden labels.
        </p>
      </div>
